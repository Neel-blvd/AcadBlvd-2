            ...
            :
                <div className='bg-zinc-900 h-screen text-orange-600 overflow-x-hidden font-mono'>
                    ...
                    <div className='absolute w-full'>
                        ...
                        <form className='w-3/4 md:w-1/3 h-96 mx-auto mt-2 border-orange-600 shadow-md shadow-orange-600 bg-neutral-900 bg-opacity-40
                            flex flex-col items-center'
                            onSubmit={(e) => handleLogIn(e)}>
                            <input required type='text' className='bg-black rounded-lg mt-14 p-2 w-3/4 md:w-2/3 focus:outline-none'
                                placeholder='Username:'
                                value={logInFormData.username}
                                onChange={(e) => setLogInFormData({...logInFormData, username: e.target.value})}>
                            </input>
                            <input required type='password' className='bg-black rounded-lg mt-14 p-2 w-3/4 md:w-2/3 focus:outline-none'
                ...
                <div className='bg-zinc-900 h-screen text-orange-600 overflow-x-hidden font-mono'>
                    ...
                    <div className='absolute w-full'>   
                        ...
                        <form className='w-3/4 md:w-1/3 h-96 mx-auto mt-2 border-orange-600 shadow-md shadow-orange-600 bg-neutral-900 bg-opacity-40
                            ...
                            <input required type='text' className='rounded-lg mt-8 p-2 w-3/4 md:w-2/3 focus:outline-none bg-black placeholder:flex-wrap'
                                placeholder='First Name:'
                                value={signUpFormData.firstName}
                                onChange={(e) => setSignUpFormData({...signUpFormData, firstName: e.target.value})}>
                            </input>
                            <input required type='text' className='rounded-lg mt-8 p-2 w-3/4 md:w-2/3 focus:outline-none bg-black placeholder:'
                                placeholder='Username:'
                            ...
                            <input required type='password' className='rounded-lg mt-4 p-2 w-3/4 md:w-2/3 focus:outline-none bg-black'
                                placeholder='Password:'
